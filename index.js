 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`neobitcoin-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`neobitcoin-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'neobitcoin-' + name : 'neobitcoin';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/neobitcoin-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external neobitcoin-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:neobitcoin-lib -o neobitcoin-lib.js';
    }
